...
export default function Row_NhanVien(truyen) {
    ...
    const onClick_button_show = () =>{
        console.log("Data_ChamCong",Data_ChamCong[truyen.index]);
        console.log("obj_nhanVien",obj_nhanVien);
    };
        ...
        <tr>
            <td className="td_sticky1" rowSpan='5'>
                <div id="div_button_save_reload_clear">
                    ...
                    {/* <button onClick={onClick_button_show}>Show</button> */}
                </div>
            </td>
